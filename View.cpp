...
void View::show() {
    ...
    int y = (size * scale + yorigin) - scale;
    int x = xorigin;
    int xend = (size * scale + xorigin) - scale;

    // i is the real y cordinate going from down
    for (int i = y , c = 0; i >= yorigin ; i -= scale , c++) {
